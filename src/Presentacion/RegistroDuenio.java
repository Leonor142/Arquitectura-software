 ...
 * @author lucas
 */
public class RegistroDuenio extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tableDuenios = new javax.swing.JTable();
        ...
        tableDuenios.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tableDuenios);
    ...
    private void tabladessing(){
        ...
        tableDuenios.setModel(model);
        cargarDatos();

    }
    private void cargarDatos() {
        Lecturatxt leer  =new Lecturatxt();
        List<Duenios> listaDuenios = leer.leerDuenios();

        for (Duenios duenio : listaDuenios) {
            model.addRow(new Object[]{duenio.getDni(), duenio.getNombre(), duenio.getCelular(), duenio.getEdad(), duenio.getDireccion()});
        }
    }
    ...
    private javax.swing.JTable tableDuenios;
